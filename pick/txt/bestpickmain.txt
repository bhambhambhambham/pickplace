            ...
            try {
                ...
                if(dimx > gripperlength && dimy > gripperlength){
                    ...
                    if((ay > 0)&&((ax > fabs(ay))&&((yaw > -pi/2 && yaw < 0)||(yaw > pi/2 && yaw < pi)))){
                        ...
                        createCollisionObjectFrameRPY(bc3, "obj", "obj_lift_pose", 0, -dimy/2-liftr, lift, 0, 0, pi/2);
                        ...
                        createCollisionObjectFrameRPY(bc6, "obj", "obj_lift_posea", -dimx/2-liftr, 0, lift, 0, 0, 0);
                        ...
                        createCollisionObjectFrameRPY(bc9, "obj", "obj_lift_poseaa", dimx/2+liftr, 0, lift, 0, 0, pi);
                        ...
                        if(graspz){
                            ...
                            createCollisionObjectFrameRPY(bc12, "obj", "obj_lift_poseaaa", 0, -dimy/2-liftr, lift, pi, 0, pi/2);
                        }
                    }
                        ...
                        createCollisionObjectFrameRPY(bc3, "obj", "obj_lift_pose", -dimx/2-liftr, 0, lift, 0, 0, 0);
                        ...
                        createCollisionObjectFrameRPY(bc6, "obj", "obj_lift_posea", 0, -dimy/2-liftr, lift, 0, 0, pi/2);
                        ...
                        createCollisionObjectFrameRPY(bc9, "obj", "obj_lift_poseaa", 0, dimy/2+liftr, lift, 0, 0, -pi/2);
                        ...
                        if(graspz){
                            ...
                            createCollisionObjectFrameRPY(bc12, "obj", "obj_lift_poseaaa", -dimx/2-liftr, 0, lift, pi, 0, 0);
                        }
                    }
                        ...
                        createCollisionObjectFrameRPY(bc3, "obj", "obj_lift_pose", dimx/2+liftr, 0, lift, 0, 0, pi);
                    }
                    else if((ay < 0)&&((ax > fabs(ay))&&((yaw > 0 && yaw < pi/2)||(yaw > -pi && yaw < -pi/2)))){
                        createCollisionObjectFrameRPY(bc1, "obj", "obj_grasp_pose", 0, dimy/2, 0, 0, 0, -pi/2);
                        createCollisionObjectFrameRPY(bc2, "obj", "obj_approach_pose", 0, dimy/2+approach, 0, 0, 0, -pi/2);
                        ...
                        createCollisionObjectFrameRPY(bc6, "obj", "obj_lift_posea", dimx/2+liftr, 0, lift, 0, 0, pi);
                        ...
                        createCollisionObjectFrameRPY(bc9, "obj", "obj_lift_poseaa", -dimx/2-liftr, 0, lift, 0, 0, 0);
                    ...
                    if(ay <= 0){
                        if(((yaw < 0 && yaw > -pi/2)&&(ax > fabs(ay)))||((yaw > pi/2 && yaw < pi)&&(ax > fabs(ay)))){
                            ...
                            if(graspz){
                                ...
                                createCollisionObjectFrameRPY(bc9, "obj", "obj_lift_poseaa", 0, -dimy/2-liftr, lift, pi, 0, pi/2);
                    ...
                    ||((ay > 0)&&(fabs(ay) > ax)&&((yaw > -pi/2 && yaw < 0)||(yaw > pi/2 && yaw < pi)))){
                        ...
                        if(graspz){
                            ...
                            createCollisionObjectFrameRPY(bc9, "obj", "obj_lift_poseaa", dimx/2+liftr, 0, lift, pi, 0, pi);
                        ...
                        if(graspz){
                            ...
                            createCollisionObjectFrameRPY(bc9, "obj", "obj_lift_poseaa", 0, 0, dimz/2+liftr, 0, pi/2, 0);
                            ...
                            createCollisionObjectFrameRPY(bc12, "obj", "obj_lift_poseaaa", 0, 0, dimz/2+liftr, pi, pi/2, 0);
                        }
                        else{
                            ...
                            createCollisionObjectFrameRPY(bc9, "obj", "obj_lift_poseaa", -dimx/2-liftr, 0, lift, pi, 0, 0);
                            ...
                            createCollisionObjectFrameRPY(bc12, "obj", "obj_lift_poseaaa", dimx/2+liftr, 0, lift, pi, 0, pi);
                        }
                    }
                }
            }
