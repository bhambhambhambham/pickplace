...
class cr3pick:
    def __init__(self):
        ...
        self.set_home_walkie(0,0,0,0,0,0, self.cartesian1, self.cartesian2)
        self.success = False
    ...
    def set_home_walkie(self,a,b,c,d,e,f, cart1, cart2):
        ...
        while (self.success == False):
            ...
            if self.success:
                ...
                if self.count == 5 and self.check == False:
                    ...
                    self.subframe3 = 'obj_lift_pose'
                    self.count = 1
                    self.set_home_walkie(0,0,0,0,0,2.355, self.cartesian1, self.cartesian2)
