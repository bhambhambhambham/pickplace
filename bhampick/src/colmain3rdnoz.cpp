            ...
            try {
                ...
                if(dimx > gripperlength && dimy > gripperlength){
                    ...
                    if((ay > 0)&&((ax > fabs(ay))&&((yaw > -pi/2 && yaw < 0)||(yaw > pi/2 && yaw < pi)))){
                        ...
                        createCollisionObjectFrameRPY(bc10, "obj", "obj_grasp_poseaaa", 0, -dimy/2, 0, 0, pi, pi/2);
                        createCollisionObjectFrameRPY(bc11, "obj", "obj_approach_poseaaa", 0, -dimy/2-0.05, 0, 0, pi, pi/2);
                        createCollisionObjectFrameRPY(bc12, "obj", "obj_lift_poseaaa", 0, -dimy/2, 0.05, 0, pi, pi/2);
                    }
                        ...
                        createCollisionObjectFrameRPY(bc11, "obj", "obj_approach_poseaaa", -dimx/2-0.05, 0, 0, pi, 0, 0);
                        createCollisionObjectFrameRPY(bc12, "obj", "obj_lift_poseaaa", -dimx/2, 0, 0.05, pi, 0, 0);
                    }
                        ...
                        createCollisionObjectFrameRPY(bc7, "obj", "obj_grasp_poseaa", 0, -dimy/2, 0, 0, pi, pi/2);
                        createCollisionObjectFrameRPY(bc8, "obj", "obj_approach_poseaa", 0, -dimy/2-0.05, 0, 0, pi, pi/2);
                        createCollisionObjectFrameRPY(bc9, "obj", "obj_lift_poseaa", 0, -dimy/2, 0.05, 0, pi, pi/2);
                        ...
                        createCollisionObjectFrameRPY(bc8, "obj", "obj_approach_poseaa", dimx/2+0.05, 0, 0, pi, 0, pi);
                        createCollisionObjectFrameRPY(bc9, "obj", "obj_lift_poseaa", dimx/2, 0, 0.05, pi, 0, pi);
